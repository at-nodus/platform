...
namespace SSO.Infrastructures.Data.Identity.Migrations
{
    ...
    [Migration("20260728041729_Phase14bInverseCollectionNavigations")]
    partial class Phase14bInverseCollectionNavigations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SSO.Core.Domain.Identity.LdapGroupRoleMaps.Entity.LdapGroupRoleMap", b =>
                {
                    ...
                    b.HasOne("SSO.Core.Domain.Identity.Roles.Entity.Role", "Role")
                        .WithMany("LdapGroupRoleMaps")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SSO.Core.Domain.Identity.Memberships.Entity.Membership", b =>
                {
                    ...
                    b.HasOne("SSO.Core.Domain.Identity.Users.Entity.User", "User")
                        .WithMany("Memberships")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SSO.Core.Domain.Identity.OrganizationInvites.Entity.OrganizationInvite", b =>
                {
                    b.HasOne("SSO.Core.Domain.Identity.Users.Entity.User", "AcceptedUser")
                        .WithMany("InvitesAccepted")
                        .HasForeignKey("AcceptedUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SSO.Core.Domain.Identity.Users.Entity.User", "InvitedByUser")
            ...
            modelBuilder.Entity("SSO.Core.Domain.Identity.RolePermissions.Entity.RolePermission", b =>
                {
                    b.HasOne("SSO.Core.Domain.Identity.Permissions.Entity.Permission", "Permission")
            ...
            modelBuilder.Entity("SSO.Core.Domain.Identity.Products.Entity.Product", b =>
                {
                    b.Navigation("ClaimDefinitions");

                    b.Navigation("ClientProductBindings");
